...
// Let's code!
// -----------
// Plan of attack: set three variables, current node and next node. current node allows you to set that as next node's new next value,
// it should cease once nextNode is null
